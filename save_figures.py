"""
Script to generate the figures for the report.
"""
...
FOLDER = "figures/" # folder where the figures are saved
DPI = 200 # high resolution figures
...
for N, M in couples:
    ...
    df = pd.read_pickle("data/markov.pkl")
